...
public class BitmapUtils {
	 ...
	 * @param dstHeight
	 * @return */
	private static Bitmap createScaleBitmap(Bitmap bitMap, int dstWidth, int dstHeight, int inSampleSize) {
	...
	public static Bitmap decodeSampledBitmapFromFile(String pathName, int reqWidth, int reqHeight) {
		...
		return createScaleBitmap(bitMap, reqWidth, reqHeight, options.inSampleSize);
	}
}